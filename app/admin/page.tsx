...
export default async function AdminDashboard() {
  ...
  const stats = [
    ...
    { label: 'Pending Listings',   value: pendingListings,   icon: Clock,          color: 'text-brand-ochre',    bg: 'bg-amber-50',         href: '/admin/listings?status=pending' },
    { label: 'Total Bookings',     value: totalBookings,     icon: Calendar,       color: 'text-purple-600',     bg: 'bg-purple-50',        href: '/admin/bookings' },
    { label: 'Confirmed Bookings', value: confirmedBookings, icon: CheckCircle,    color: 'text-status-success', bg: 'bg-emerald-50',       href: '/admin/bookings?status=confirmed' },
  ]
